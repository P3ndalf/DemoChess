...
namespace Chess
{
    class Moves
    {
        ...
        public Moves(Board _board)
        {
            this.board = _board;
        }

        public bool canMove(FigureMoving _fm)
        {
            this.fm = _fm;
        ...
        bool canFigureMove()
        {
            switch (fm.figure)
            {
                ...
                case Figure.blackBishop:
                    return (fm.SignY != 0 && fm.SignX != 0) && CanStraightMove();
       ...
       private bool CanKnightMove()
        ...
        private bool CanPawnMove()
        {
            ...
            return CanPawnGo(stepY) ||
                    CanPawnJump(stepY) ||
                    CanPawnEat(stepY); // + еще одна функция взятие на проходе
        }
